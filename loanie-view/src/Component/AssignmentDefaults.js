export function assignmentDefaults(loanType) {
  const refDefs = [
    ...
    {
      text:
        "Explanation of any assets used for down payment and closing costs - source of funds",
      author: "1",
      phase: "2",
      complete: false,
    },
    ...
    {
      text:
        "Rate can be locked after appraisal - consumer must decide when to lock",
      author: "1",
      phase: "3",
      complete: false,
    },
    ...
    {
      text:
        "Make your home improvements - pay down debt - whatever your plans were",
      author: "1",
      phase: "5",
      complete: false,
    },
  ...
  const conDefs = [
    ...
    {
      text:
        "Look at your finances and see what your down payment amount will likely be (0 - 20%)",
      author: "1",
      phase: "1",
      complete: false,
    },
    {
      text:
        'Come up with a basic "wish list" on the property you are looking for',
      author: "1",
      phase: "1",
      complete: false,
    },
